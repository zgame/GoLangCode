...
//}
// 生成钻石的增加语句
//func GetDiamondAddSql(rechargeInfo UserList, getDiamond int, dbNow *sql.DB,dataTimeStr string,dbName string, day1 string) string {
...
// 生成钻石减少的语句
func GetDiamondReduceSql(rechargeInfo UserList, reduceDiamond int, dbNow *sql.DB,dataTimeStr string,dbName string, day1 string,lastAllDiamond int)  {
...
// 生成灵力减少的语句
func GetCoinReduceSql(rechargeInfo UserList, reduceCoin int, dbNow *sql.DB,dataTimeStr string,dbName string, day1 string, lastAllCoin int)  {
...
// 生成道具的充值语句
//func GetItemRechargeSql(rechargeInfo UserList, itemId int, itemNum int, dbNow *sql.DB,dataTimeStr string,dbName string, day1 string,  title string, TestDB *sql.DB) int {
...
// 生成道具减少的语句
func GetItemReduceSql(rechargeInfo UserList, itemId int, itemNum int, dbNow *sql.DB,dataTimeStr string,dbName string, day1 string,lastAllItem int )  {
	if itemId == 3102 {
		return
	}
