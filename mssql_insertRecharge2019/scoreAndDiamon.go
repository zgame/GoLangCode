...
// 生成金币的充值语句
func GetScoreRechargeSql(rechargeInfo RechargeList, getGold int, dbNow *sql.DB,dataTimeStr string,dbName string, day1 string, goldType int, subType int, title string, extend int, DataBYDB *sql.DB) int {
	reason := "系统赠送"
	if title == "游戏写分"{
		reason = "游戏操作"
	}
	lastAllGold := GetHistoryScore(DataBaseBYDBName, day1,DataBYDB,rechargeInfo.UserId,rechargeInfo.SuccessTime, rechargeInfo,nil)     // 获取玩家的历史金币数量
...
// 生成钻石的充值语句
func GetDiamondRechargeSql(rechargeInfo RechargeList, getDiamond int, dbNow *sql.DB,dataTimeStr string,dbName string, day1 string, DiamondType int, subType int, title string, extend int, DataBYDB *sql.DB) int {
	lastAllDiamond := GetHistoryDiamond(DataBaseBYDBName, day1,DataBYDB,rechargeInfo.UserId,rechargeInfo.SuccessTime, rechargeInfo,nil)                                               // 获取玩家的历史钻石数量
...
// 生成灵力的充值语句
func GetCoinRechargeSql(rechargeInfo RechargeList, getCoin int, dbNow *sql.DB,dataTimeStr string,dbName string, day1 string, Type int, subType int, title string, DataBYDB *sql.DB) int {
	table:= ZRandomTo(10,200)
	lastAllCoin := GetHistoryCoin(DataBaseBYDBName, day1,DataBYDB,rechargeInfo.UserId,rechargeInfo.SuccessTime, rechargeInfo,nil) // 获取玩家的历史灵力数量
...
// 生成道具的充值语句
func GetItemRechargeSql(rechargeInfo RechargeList, itemId int, itemNum int, dbNow *sql.DB,dataTimeStr string,dbName string, day1 string,  title string, DataBYDB *sql.DB) int {
	lastAllItem := GetHistoryItem(DataBaseBYDBName, day1,DataBYDB,rechargeInfo.UserId,rechargeInfo.SuccessTime, rechargeInfo,itemId,nil) // 获取玩家的历史灵力数量
