...
// 生成金币的充值语句
func GetScoreRechargeSql(rechargeInfo RechargeList, getGold int, dbNow *sql.DB,dataTimeStr string,dbName string, day1 string, goldType int, subType int, title string, extend int, TestDB *sql.DB) int {
	reason := "系统赠送"
	if title == "游戏写分"{
		reason = "游戏操作"
	}
...
// 生成钻石的充值语句
func GetDiamondRechargeSql(rechargeInfo RechargeList, getDiamond int, dbNow *sql.DB,dataTimeStr string,dbName string, day1 string, DiamondType int, subType int, title string, extend int, TestDB *sql.DB) int {
...
// 生成灵力的充值语句
func GetCoinRechargeSql(rechargeInfo RechargeList, getCoin int, dbNow *sql.DB,dataTimeStr string,dbName string, day1 string, Type int, subType int, title string, TestDB *sql.DB) int {
	table:= ZRandomTo(10,200)
...
// 生成道具的充值语句
func GetItemRechargeSql(rechargeInfo RechargeList, itemId int, itemNum int, dbNow *sql.DB,dataTimeStr string,dbName string, day1 string,  title string, TestDB *sql.DB) int {
