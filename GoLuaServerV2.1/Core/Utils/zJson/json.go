...
// LuaJsonLoad adds json to the given Lua state's package.preload table. After it
// has been preloaded, it can be loaded using require:
//
//  local json = require("json")
func LuaJsonLoad(L *lua.LState) {
	L.PreloadModule("json", loaderJson)
}

// loaderJson is the module loader function.
func loaderJson(L *lua.LState) int {
	t := L.NewTable()
	L.SetFuncs(t, api)
	L.Push(t)
	return 1
