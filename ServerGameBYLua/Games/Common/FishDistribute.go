...
// ------------------------初始化鱼池的生成组----------------------------
func (table *CommonTable) InitDistributeInfo(roomScore int) {
...
// --------------------------循环鱼池的生成组--------------------------------
func (table *CommonTable) RunDistributeInfo(roomScore int) {
	//fmt.Println("循环鱼池的生成")
...
// --------------------------循环Boss鱼池的生成组--------------------------------
func (table *CommonTable) RunBossDistributeInfo(roomScore int) {
	return
...
// ------------- 具体生成鱼 --------------------
func (table *CommonTable)DistributeNewFish(Distribute FishDistributeInfo, offsetX float32, offsetY float32)  {
	kindId := Distribute.FishKindID
	// 创建鱼
