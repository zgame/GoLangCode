...
function GoCallLuaStartGamesServers()
    ...
    AddGame("推币10倍", GameTypeTB10 , 10)    -- 10倍房间
    AddGame("推币100倍", GameTypeTB100 , 100)    -- 100倍房间
    AddGame("推币1000倍", GameTypeTB1000 , 1000)    -- 1000倍房间
    AddGame("推币10000倍", GameTypeTB10000 , 10000)    -- 10000倍房间
    --AddGame("满贯捕鱼2", GameTypeBY2)
    --AddGame("满贯捕鱼3", GameTypeBY3)

    SetNewTimer("NewTimerBy10Second",10)      -- lua 自己设定计时器
    SetNewTimer("NewTimerBy5Second",5)      -- lua 自己设定计时器
