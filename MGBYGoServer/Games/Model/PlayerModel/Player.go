...
//
//	GetUser() *UserModel.UserModel       // 获取玩家的总数据
//	SetUser(player *UserModel.UserModel) // 设定玩家的总数据
//
...
// -------------------------构造函数-------------------------
func  NewPlayer(user *UserModel.UserSave) *Player {
...
// 获取玩家的总数据
func (player *Player) GetUser() *UserModel.UserSave {
	return player.UserSave
}
// 设置玩家的总数据
func (player *Player) SetUser(save *UserModel.UserSave) {
