...
// Preload adds json to the given ZServer state's package.preload table. After it
...
// Decode converts the JSON encoded data to ZServer values.
...
// DecodeValue converts the value to a ZServer value.
//
