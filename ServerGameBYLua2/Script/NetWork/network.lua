...
function GoCallLuaNetWorkReceive(serverId,msgId,subMsgId,data)
    ...
    ReceiveMsg(serverId,msgId,subMsgId,data)
...
-- 根据命令进行分支处理
function ReceiveMsg(serverId,msgId,subMsgId,data)
